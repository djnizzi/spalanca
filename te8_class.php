...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
 <tr>
  ...
  $result=MYSQL_QUERY("SELECT tc_points, tc_pid FROM te8_playaz ORDER BY tc_points DESC");
if ($myrow = mysql_fetch_array($result)) {
	do{
printf("<tr><td class=masblack valign=top><a href=te8_scheda.php?zid=%s>%s</a></td><td background=images/te8_bk.jpg align=right ><a href=te8_scheda.php?zid=%s></td><td class=mascont align=center><b>%s</b></td></tr>",urlencode($myrow["tc_pid"]),$myrow["tc_pid"],urlencode($myrow["tc_pid"]),$myrow["tc_points"]);
