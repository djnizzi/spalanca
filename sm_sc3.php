...
print("	    <td class=masblack valign=top>$zid</td><td background=images/sm_bk.jpg align=right width=78>". $avatarurl ."</td><td class=mascont align=center><b><font size=+3>$sm_points</font></b><br>punti</td>");
    ?></tr></table></td></tr>
 <?php 
   $result=MYSQL_QUERY("SELECT sm_points FROM sm_playaz WHERE sm_pid='$zid'");
if (@MYSQL_RESULT($result,0,"sm_points")==null){
