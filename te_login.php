<?php
$logform1="<script>var gfunk = new String(parent.location);if (gfunk.indexOf('noid')>-1){parent.location='te_home.php';}</script>";
$logform2="<FORM name=logform action=te_rulez.php?loginsub=1 method=post>".
