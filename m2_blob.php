...
$allteams="";
$result2=MYSQL_QUERY("SELECT sm_tid FROM m2_teams ORDER BY sm_tid");
...
$result=MYSQL_QUERY("UPDATE m2_teams SET sm_flag='$data',sm_flagfn='$pbindata_name' WHERE sm_tid='$squadra'");
}

?>
<table><tr><td><form  enctype="multipart/form-data" method=post name=robba action=m2_blob.php><table class=masall width=100% border=0 cellspacing=0 cellpadding=0 class=mascont2>
