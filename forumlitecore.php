...
printf("scritto da <a href=scheda.php?zid=%s>%s</a> - inviato %s</td>$spaltb2<td valign=top $spaltb3 align=center rowspan=2><a href=scheda.php?zid=%s><img src=getdata.php?zid=%s&wht=users border=0 width=50 height=50></a></td></tr>",urlencode($myrow["fuid"]),$myrow["fuid"],$postato,urlencode($myrow["fuid"]),urlencode($myrow["fuid"]));
printf("<tr><td class=mascont2 colspan=2 valign=top>%s", stefize($myrow["fcontent"]));
...
printf("<a href=forumlite.php?fid=%s>%s</a></span><br>ultimo messaggio di <a href=scheda.php?zid=%s>%s</a> - %s - %s messaggi%s</td><td align=right $spaltb1><a href=scheda.php?zid=%s><img src=getdata.php?zid=%s&wht=users border=0  width=50 height=50></a></td>",$myrow["reply"],$myrow["thread"],urlencode($highlander),$highlander,$postato,@MYSQL_RESULT($result2,0,"msgs"),$pluro,urlencode($highlander),urlencode($highlander));
