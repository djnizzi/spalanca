...
<table width="901"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="60" valign="top"><img src="<?php echo $condir; ?>/clogo1.gif" width="60" height="196"></td>
    <td valign="top"><table width="841" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="841" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="51"><img src="<?php echo $condir; ?>/clogo2.gif" width="51" height="80"></td>
...
?></td>            
  ...
  <form action=conresults.php?conid=<?php echo $conid; ?> method=post name=ftf ><tr>
    <td bgcolor="#C75A00"><input name="fts" type="text" class="srcfld"></td>
  </tr></form>
</table>
</td>
