<?php
$logform1="<script>var gfunk = new String(parent.location);if (gfunk.indexOf('noid')>-1){parent.location='t11_home.php';}</script>";
$logform2="<FORM name=logform action=t11_rulez.php?loginsub=1 method=post>".
