...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
 <tr>
  ...
  $result=MYSQL_QUERY("SELECT tc_points, tc_pid FROM t8_playaz ORDER BY tc_points DESC");
...
<?php	
$result=MYSQL_QUERY("SELECT count(*) as segnari, tc_16tid, tc_flagfn FROM t8_16teams, t8_teams WHERE tc_16tid=tc_tid AND tc_16w='W'  GROUP BY tc_16tid  ORDER BY segnari DESC");
if ($myrow = mysql_fetch_array($result)) {
	do{
