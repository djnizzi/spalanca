...
if (@MYSQL_RESULT($result,0,"tc_points")==null){
  ...
  mysql_select_db($database2);
print("	    <td class=masblack valign=top>$zid</td><td background=images/te12_bk.jpg align=right width=78>". $avatarurl ."</td><td class=mascont align=center><b><font size=+3>$tc_points</font></b><br>punti</td>");
    ?></tr></table></td></tr>
