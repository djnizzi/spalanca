...
$result=MYSQL_QUERY("UPDATE tc_teams SET tc_flag='$data',tc_flagfn='$pbindata_name' WHERE tc_tid='$squadra'");
}

?>
<table><tr><td><form  enctype="multipart/form-data" method=post name=robba action=tc_blob.php><table class=masall width=100% border=0 cellspacing=0 cellpadding=0 class=mascont2>
