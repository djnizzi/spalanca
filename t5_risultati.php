...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
 <tr>
  ...
  <?php
$result=MYSQL_QUERY("SELECT  tc_mid, tc_team1, tc_team2,  tc_g1, tc_g2, UNIX_TIMESTAMP(tc_date) as ladata, tc_group FROM t5_match, t5_teams WHERE tc_tid=tc_team1 AND tc_play='Y' ORDER BY tc_date");
if ($myrow = mysql_fetch_array($result)) {
	do{$gole="";
$xpu=""; $matchid=$myrow["tc_mid"];$sijuega= date("d/m/Y H:i", $myrow["ladata"]);
	$result2=MYSQL_QUERY("SELECT  tc_name1 FROM t5_goal, t5_stars WHERE tc_gmid=$matchid AND tc_sid=tc_gsid ORDER BY tc_name1");
	...
	$result2=MYSQL_QUERY("SELECT  tc_name1 FROM t5_sentoff, t5_stars WHERE tc_smid=$matchid AND tc_sid=tc_ssid ORDER BY tc_name1");
	...
	if ($myrow["ladata"]<mktime (0,0,0,12,9,2005)) {$whatmatch="Fase I - Gruppo " . $myrow["tc_group"];} else 
	if ($myrow["ladata"]<mktime (0,0,0,3,15,2006)){$whatmatch="1/8 finale"  . $myrow["tc_group2"];} else
	if ($myrow["ladata"]<mktime (0,0,0,4,6,2006)){$whatmatch="1/4 finale";}else 
	if ($myrow["ladata"]<mktime (0,0,0,4,27,2006)){$whatmatch="semifinale";}else {$whatmatch="finale";}
  ...
  <?php
$result=MYSQL_QUERY("SELECT  tc_team1, tc_team2, UNIX_TIMESTAMP(tc_date) as ladata, tc_group FROM t5_match, t5_teams WHERE tc_tid=tc_team1 AND tc_play='N' ORDER BY tc_date");
if ($myrow = mysql_fetch_array($result)) {
	...
	if ($myrow["ladata"]<mktime (0,0,0,4,27,2006)){$whatmatch="semifinale";}else {$whatmatch="finale";}
	printf ("<tr><td class=mascont>%s</td><td class=mascont>%s</td>", $sijuega,$whatmatch);
	printf ("<td align=right class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mastoxic>%s</td><td align=center class=mastoxic> - </td><td align=right class=mastoxic>%s</td><td class=mastoxic><img src=t5_getdata.php?tid=%s></td></tr>",urlencode($myrow["tc_team1"]),$myrow["tc_team1"],$myrow["tc_team2"],urlencode($myrow["tc_team2"]));
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='A' ORDER BY tc_points DESC, dr DESC, tc_gf DESC,  tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='B' ORDER BY tc_points DESC, dr DESC, tc_gf DESC,  tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='C' ORDER BY tc_points DESC, dr DESC, tc_gf DESC, tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='D' ORDER BY tc_points DESC, dr DESC, tc_gf DESC, tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='E' ORDER BY tc_points DESC, dr DESC, tc_gf DESC,   tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='F' ORDER BY tc_points DESC, dr DESC, tc_gf DESC,   tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='G' ORDER BY tc_points DESC, dr DESC, tc_gf DESC,   tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php
$result=MYSQL_QUERY("SELECT  tc_tid, tc_gf, tc_ga, tc_gp, tc_points, (tc_gf-tc_ga) as dr FROM t5_teams WHERE tc_group='H' ORDER BY tc_points DESC, dr DESC, tc_gf DESC,   tc_tid");
if ($myrow = mysql_fetch_array($result)) { do {	
	printf ("<tr><td class=mastoxic><img src=t5_getdata.php?tid=%s></td><td class=mascont align=center>%s</td><td class=mascont  align=center>%s - %s</td><td class=mascont  align=center><b>%s</td></tr>", urlencode($myrow["tc_tid"]), $myrow["tc_gp"],$myrow["tc_gf"],$myrow["tc_ga"],$myrow["tc_points"]);
...
<?php } else { ?><script>parent.location='t5_noid.php'</script><?php }  include ("sm_copy.php");?>
